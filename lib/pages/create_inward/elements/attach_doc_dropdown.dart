...
class AttachDocumentDropDown extends StatelessWidget {
  AttachDocumentDropDown(
      {Key? key,
        this.attachedDocList=const[],
        this.selectedDoc,
        required this.myDateSetter})
      : super(key: key);

  final List<DocumentData> attachedDocList;
  final DocumentData? selectedDoc;
  final ValueChanged<DocumentData> myDateSetter;
